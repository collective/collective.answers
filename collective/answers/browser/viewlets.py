...
class QAViewlet(ViewletBase):
    ...
    def questions(self):
        ...
        query = {'portal_type': 'collective.answers.question',
    ...
    def is_enabled(self):
        """
        At the moment we just return true, but this will be elaborated in 
        inheriting classes in order to check subscription, credits, access, etc.
        """
        return True
