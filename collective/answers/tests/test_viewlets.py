...
class TestQuestionAddViewlet(CollectiveAnswersTestBase):
    ...
    def test_create_question_without_text(self):
        ...
        request.form['collective.answers.questionadd.form.submitted'] = 'submitted'
        viewlet[0].update()
        self.assertTrue(
...
class TestQuestionsListViewlet(CollectiveAnswersTestBase):
